...
csvFile = open('/Users/laptop/github/100daysofpython/day_005/climbinglog.csv','a',newline='')
...
print(date_time)
csvWriter.writerow([date_time,climb_number,wall_type,grade,pre_body,pre_heart])
